...
# Reproduce the vanilla vLLM baseline for the GLM-4.6-FP8 mini-swe-agent
# SWE-bench run. This bypasses ThunderAgent:
#
#   mini-swe-agent -> vLLM
#
...
SWEBENCH_OUTPUT="./swebench_output_vllm"

# Keep baseline artifacts separate from the ThunderAgent run.
LOG_DIR="./logs/vllm_baseline"
...
run_swebench() {
  log_info "Running mini-extra swebench directly against vanilla vLLM"
  mini-extra swebench \
